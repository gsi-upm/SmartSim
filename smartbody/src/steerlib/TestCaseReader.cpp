...
void TestCaseReader::readTestCaseFromFile( const std::string & testCaseFilename )
{
	...
	GridDatabase2D * testCaseDB = new GridDatabase2D(_header.worldBounds.xmin, _header.worldBounds.xmax, _header.worldBounds.zmin, _header.worldBounds.zmax, 200, 200, 10);
