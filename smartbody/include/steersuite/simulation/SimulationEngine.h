...
namespace SteerLib {
	...
	public:
		...
		bool update( bool advanceRealTimeOnly,  bool overrideClockTime = false, float newOverrideTime = 0.0);
		//@}
	#ifdef ENABLE_GUI
	...
	protected:
		...
		bool _simulateOneStep( bool overrideClockTime, float newOverrideTime);
