...
namespace Util {
	...
	public:
		...
		//@{	
		/// It performance is important, use lengthSquared when possible instead of length(), because it avoids a costly square root.
	...
	/// Returns a vector that is rotated in the x-z plane by the specified angle in degrees.
	...
	/// Returns a point that is rotated in the x-z plane by the specified angle in degrees.
