...
brad.addJointTrajectoryConstraint('l_forefoot','base')
brad.addJointTrajectoryConstraint('r_forefoot','base')
brad.addJointTrajectoryConstraint('l_ankle','base')
brad.addJointTrajectoryConstraint('r_ankle','base')
